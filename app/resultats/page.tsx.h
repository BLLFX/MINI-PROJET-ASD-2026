...
// UTF-8 encoded string from: Votes%20blancs%20et%20exprim%C3%A9s%20par%20d%C3%A9partement
static const unsigned char widget_text_16[] = {0x56, 0x6f, 0x74, 0x65, 0x73, 0x20, 0x62, 0x6c, 0x61, 0x6e, 0x63, 0x73, 0x20, 0x65, 0x74, 0x20, 0x65, 0x78, 0x70, 0x72, 0x69, 0x6d, 0xc3, 0xa9, 0x73, 0x20, 0x70, 0x61, 0x72, 0x20, 0x64, 0xc3, 0xa9, 0x70, 0x61, 0x72, 0x74, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0};
// UTF-8 encoded string from: %EE%88%9C
static const unsigned char widget_text_17[] = {0xee, 0x88, 0x9c, 0};
// UTF-8 encoded string from: D%C3%A9tail%20par%20bureau%20de%20vote
static const unsigned char widget_text_18[] = {0x44, 0xc3, 0xa9, 0x74, 0x61, 0x69, 0x6c, 0x20, 0x70, 0x61, 0x72, 0x20, 0x62, 0x75, 0x72, 0x65, 0x61, 0x75, 0x20, 0x64, 0x65, 0x20, 0x76, 0x6f, 0x74, 0x65, 0};
...
static void resultats_page_load_template(ui_widget_t *parent, resultats_page_refs_t *refs)
{
        ...
        ui_widget_add_class(w[24], "bg-surface-container-lowest border border-outline-variant rounded-xl p-6 mb-4 flex flex-col");
        w[25] = ui_create_widget("text");
        ui_widget_add_class(w[25], "text-headline-sm text-on-surface mb-4");
        ui_widget_set_text(w[25], (const char*)widget_text_16);
        refs->departements = ui_create_widget(NULL);
        ui_widget_add_class(refs->departements, "flex flex-col");
        ui_widget_append(w[24], w[25]);
        ui_widget_append(w[24], refs->departements);
        w[26] = ui_create_widget(NULL);
        ui_widget_add_class(w[26], "bg-surface-container-lowest border border-outline-variant rounded-xl p-6 flex flex-col");
        w[27] = ui_create_widget(NULL);
        ui_widget_add_class(w[27], "flex flex-row items-center mb-4");
        w[28] = ui_create_widget("text");
        ui_widget_add_class(w[28], "fui-icon-regular text-primary mr-2");
        ...
        ui_widget_add_class(w[29], "text-headline-sm text-on-surface");
        ...
        ui_widget_append(w[26], refs->bureaux);
